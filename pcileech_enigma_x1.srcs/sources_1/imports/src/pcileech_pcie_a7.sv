...
module pcileech_pcie_a7(
    ...
    // Advanced PCIe features for Intel HD Audio emulation
    // ----------------------------------------------------
    
    wire [31:0] audio_tlp_control;
    wire [15:0] audio_flow_control_credits;
    wire [7:0]  audio_link_state;
    wire        audio_error_detected;
    wire [31:0] audio_power_state;
    
    intel_audio_pcie_protocol_controller i_intel_audio_pcie(
        .clk                    ( clk_pcie                  ),
        .rst                    ( rst_pcie                  ),
        ...
        .tlp_control_out        ( audio_tlp_control         ),
        .flow_control_credits   ( audio_flow_control_credits),
        .link_state             ( audio_link_state          ),
        .error_detected         ( audio_error_detected      ),
        .power_state            ( audio_power_state         ),
        
        // Intel Audio Specific
        .audio_codec_ready      ( 1'b1                      ),
        .audio_stream_active    ( 1'b0                      ),
        .audio_dma_enable       ( 1'b1                      )
    );
