...
#
# Script generated by Vivado on Sun Aug 03 21:42:49 +0900 2025
...
#
# Usage        : pcie_7x_0.sh
#                pcie_7x_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pcie_7x_0.sh [-reset_run]
#                pcie_7x_0.sh [-reset_log]
#                pcie_7x_0.sh [-help]
#
...
# script info
echo -e "pcie_7x_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pcie_7x_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pcie_7x_0 xil_defaultlib.pcie_7x_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pcie_7x_0.wdb xsim.dir libdpi.so)
...
Usage: pcie_7x_0.sh [-step]\n\
Usage: pcie_7x_0.sh [-lib_map_path]\n\
Usage: pcie_7x_0.sh [-reset_run]\n\
Usage: pcie_7x_0.sh [-reset_log]\n\
Usage: pcie_7x_0.sh [-keep_index]\n\
